...
//-------------------------------------------
//-------------------------------------------
uint32_t GameMain::randxs32()
{
  m_xs32 = m_xs32 ^ (m_xs32 << 13);
  m_xs32 = m_xs32 ^ (m_xs32 >> 17);
  m_xs32 = m_xs32 ^ (m_xs32 << 15);
  return m_xs32;
}

uint16_t GameMain::randxs32Mod( uint16_t v )
{
  return (uint16_t)(randxs32() % v);
}
